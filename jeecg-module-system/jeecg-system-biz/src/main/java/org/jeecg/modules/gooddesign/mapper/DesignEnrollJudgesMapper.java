...
public interface DesignEnrollJudgesMapper extends BaseMapper<DesignEnrollJudges> {
    ...
    List<DesignTopJudgesScoreVO> pageByNameAndTopStatus(Page<DesignTopJudgesScoreVO> page, String realName, Integer topStatus, Integer sortStatus, List<Integer> activityIds);
