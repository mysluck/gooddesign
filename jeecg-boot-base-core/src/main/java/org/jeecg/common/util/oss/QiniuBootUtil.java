...
public class QiniuBootUtil {
    ...
    public static void setEndPoint(String endPoint) {
        QiniuBootUtil.endPoint = endPoint;
    }

    public static void setAccessKeyId(String accessKeyId) {
        QiniuBootUtil.accessKeyId = accessKeyId;
    }

    public static void setAccessKeySecret(String accessKeySecret) {
        QiniuBootUtil.accessKeySecret = accessKeySecret;
    }

    public static void setBucketName(String bucketName) {
        QiniuBootUtil.bucketName = bucketName;
    }

    public static void setStaticDomain(String staticDomain) {
        QiniuBootUtil.staticDomain = staticDomain;
    }
    ...
    */
    ...
    public static InputStream getOssFile(String objectName,String bucket){
        ...
        try{
            ...
            objectName = QiniuBootUtil.replacePrefix(objectName,bucket);
    ...
    public static String getObjectUrl(String bucketName, String objectName, Date expires) {
        ...
        try{
            //update-begin---author:liusq  Date:20220120  for：替换objectName前缀，防止key不一致导致获取不到文件----
            objectName = QiniuBootUtil.replacePrefix(objectName,bucketName);
            //update-end---author:liusq  Date:20220120  for：替换objectName前缀，防止key不一致导致获取不到文件----
